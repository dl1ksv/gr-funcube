...
class FMRadiofcd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMRadiofcd")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.funcube_fcd_0 = funcube.fcd('')

        self.funcube_fcd_0.set_freq(RxFrequency*1000)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.qtgui_sink_x_0, 'freq'), (self.funcube_fcd_0, 'freq'))
        ...
        self.connect((self.funcube_fcd_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.funcube_fcd_0, 0), (self.qtgui_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(5, self.samp_rate, 40000, 500, firdes.WIN_HAMMING, 6.76))
    ...
    def set_RxFrequency(self, RxFrequency):
        ...
        self.funcube_fcd_0.set_freq(self.RxFrequency*1000)
        self.qtgui_sink_x_0.set_frequency_range(self.RxFrequency*1000, self.samp_rate)
...
def main(top_block_cls=FMRadiofcd, options=None):
